    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">  
            <div class="row mb-2 p-2">
                <div class="col-md-4">
                    <h2><strong>List of Member Types</strong></h2>
                </div>
                ...
                <div class="col-md-8">
                    ...
                    <b-form @submit.stop.prevent="onFilterSubmit" class="pull-right m-2" size="sm">
                        <b-input-group>
                            <b-form-input id="name" v-model="filterForm.name" type="text" placeholder="Search type"></b-form-input>
                        ...
                        <tbody>
                            <tr v-for="type in types.data" :key="type.id">
                                ...
                                <td v-if="unprintable==false">
                                    <b-dropdown id="dropdown-right" text="Action" variant="info" v-if="type.system==0" >
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            Entries</b>
                            <br> Total: <b>{{ count_all }} Member Types</b>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadTypes() {
                ...
                axios.get("/api/members/types", { params: this.filterForm })
                .then(({ data }) => {
            ...
            getResults(page = 1) {
                axios.get("/api/members/types?page=" + page, { params: this.filterForm })
                .then(response => {
            ...
            createType() {
                ...
                this.form.post("/api/members/types")
                .then(() => {
                    Swal.fire(
                        "Created!",
                        "Member Types Created Successfully.",
                        "success"
                    );
                    this.loadTypes(); 
                })
            ...
            updateType() {
                ...
                this.is_busy = true;
                $("#addNewType").modal("hide");
                this.form.put("/api/members/types/" + this.form.id)
                .then(() => {
                    Swal.fire("Updated!", "Member Types Updated Successfully.", "success");
                    this.loadTypes(); 
                })
            ...
            onDeleteAll(id) {
                ...
                .then(result => {
                    if (result.value) {
                        if (this.is_busy) return;
                        this.is_busy = true;
                        axios.get('/api/members/types/delete', { params: this.action})
                        .then(() => {
                            Swal.fire(
                                "Deleted!",
