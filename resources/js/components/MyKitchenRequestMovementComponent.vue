    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">
            <div class="row mb-2 p-2">
                <div class="col-md-6">
                    <h2><strong>My Kitchen Item Requests</strong></h2>
                </div>

                <div class="col-md-6" v-if="user.role==1 || user.role==14 || user.role==15">
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr  v-for="(inventory, index) in inventories.data">
                                <td v-if="user.role==1 || user.role==14 || user.role==15">
    ...
    export default {
        ...
        methods: {
            ...
            loadInventory() {
                ...
                axios.get("/api/kitchen/movement/request", { params: this.filterForm })
                .then(({ data }) => {
                    console.log(data)
            ...
            getResults(page = 1) {
                axios.get("/api/kitchen/movement/request?page=" + page, { params: this.filterForm })
                .then(response => {
            ...
            accept() {
                ...
                .then(result => {
                    if (result.value) {
                        axios.get('/api/kitchen/accept', { params: this.action})
                        .then(() => {
                            Swal.fire(
                                "Accepted!",
            ...
            reject() {
                ...
                .then(result => {
                    if (result.value) {
                        axios.get('/api/kitchen/reject', { params: this.action})
                        .then(() => {
                            Swal.fire(
                                "Cancel!",
                                "Product cancel.",
