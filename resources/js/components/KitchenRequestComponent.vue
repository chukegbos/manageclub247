    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">
            <div class="row mb-2 p-2">
                <div class="col-md-6">
                    <h2><strong>Kitchen Item Requests</strong></h2>
                </div>
                        ...
                        <tbody>
                            <tr  v-for="(inventory, index) in inventories.data">
                                <td v-if="admin.role==1 || admin.role==9 ||admin.role==11"> 
                                    <span v-if="inventory.available >= inventory.quantity">
                                    ...
                                    <span class="fa fa-times fa-2x text-red" v-else></span>
                                </td>
    ...
    export default {
        ...
        methods: {
            ...
            loadInventory() {
                ...
                axios.get("/api/kitchen/movement", { params: this.filterForm })
                .then(({ data }) => {
            ...
            getResults(page = 1) {
                axios.get("/api/kitchen/movement?page=" + page, { params: this.filterForm })
                .then(response => {
            ...
            accept() {
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        axios.get('/api/kitchen/outlet/accept', { params: this.action})
                        .then(() => {
                            Swal.fire(
                                "Accepted!",
            ...
            reject() {
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        axios.get('/api/kitchen/outlet/reject', { params: this.action})
                        .then(() => {
                            Swal.fire(
                                "No approved!",
