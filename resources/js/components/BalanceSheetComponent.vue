    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">
            ...
            <div class="row mb-2 p-2">
                <!--<div class="col-md-6">
                    <h2><strong>Statement of Financial Position</strong></h2>
                </div>-->
            ...
            <div class="card">
                <div class="text-center p-2">
                    <h4><strong>{{ site.sitename }} - Statement of Financial Position as at {{ filterForm.end_date | myDate }}</strong></h4>
                </div>
                <div class="card-body table-responsive p-0">
                    <table class="table table-hover">
                        <thead>
                            <tr>
                                <th><h5><b>Assets</b></h5></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </thead>
                        ...
                        <thead>
                            <tr>
                                <th><h5><b>Liabilities + Equity</b></h5></th>
                                <th></th>
                                <th></th>
                            </tr>
                        </thead>
    ...
    export default {
        ...
        methods: {
            ...
            loadAccount() {
                ...
                axios.get("/api/account/balancesheet", { params: this.filterForm })
                .then(({ data }) => {
