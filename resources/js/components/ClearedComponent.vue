    ...
    <b-overlay :show="is_busy" rounded="sm">
        <div class="container-fluid">
            <div class="row mb-2 p-2">
                <div class="col-md-8">
                    <h3><strong>List of members not owing</strong></h3>                   
                </div>
                ...
                <span id="printMe">
                    <div class="card-body table-responsive p-0"  v-if="unprintable==true">
                        <div class="text-center">
                            <h2>Enugu Sports Club - List of member not owing</h2>
                        </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadSales() {
                ...
                axios.get('/api/store/notowing', { params: this.filterForm })
                .then(({ data }) => {
